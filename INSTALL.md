...
Don't worry, NewSur installer already provides all of those dependencies.
</details>
...
Run `./install.sh` to install the default NewSur GTK theme pack which includes
...
```bash
 ...
 Set destination directory. Default is '/home/vince/.themes'
  ...
  -n, --name NAME
 Set theme name. Default is 'NewSur'
 ...
 Remove all installed NewSur themes.
...
-F, --flatpak
Connect 'NewSur' theme to Flatpak.

-s, --snap
Connect 'NewSur' theme the currently installed snap apps.

-g, --gdm
Install 'NewSur' theme for GDM. Requires to run this shell as root

-d, --dash-to-dock
Install 'NewSur' theme for Dash to Dock and connect it to the current Dash to Dock installation(s).

-N, --no-darken
Don't darken 'NewSur' GDM theme background image.

-n, --no-blur
Don't blur 'NewSur' GDM theme background image.

-b, --background [default|blank|IMAGE_PATH]
Set 'NewSur' GDM theme background image. Default is BigSur-like wallpaper

-o, --opacity [normal|solid]
Set 'NewSur' GDM theme opacity variants. Default is 'normal'

-c, --color [light|dark]
Set 'NewSur' GDM and Dash to Dock theme color variants. Default is 'light'

-t, --theme [default|blue|purple|pink|red|orange|yellow|green|grey]
Set 'NewSur' GDM theme accent color. Default is BigSur-like theme

-p, --panel [default|30|45|60|75]
Set 'NewSur' GDM (GNOME Shell) theme panel transparency. Default is 15%

-i, --icon [standard|simple|gnome|ubuntu|arch|manjaro|fedora|debian|void]
Set 'NewSur' GDM (GNOME Shell) 'Activities' icon. Default is 'standard'
...
## Using NewSur theme on app sandboxing platforms
<p align="center"> <img src="https://github.com/vinceliuice/WhiteSur-gtk-theme/blob/pictures/pictures/sandboxes.png"/> </p>

### <p align="center"> <b> Connect NewSur theme to Flatpak </b> </p>
Parameter: `--flatpak` `-F`

Example: `./tweaks.sh -F`

### <p align="center"> <b> Connect NewSur theme to your Snap apps </b> </p>
Parameter: `--snap` `-s`
...
> This can only connect NewSur theme to your currently installed Snap
